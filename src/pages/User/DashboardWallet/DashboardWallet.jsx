        ...
        <div className={styles.mainContent}>
            ...
            <div className={styles.tabContent}>
                ...
                <div className={styles.walletSummary}>
                    ...
                    <button className={styles.payNowBtn}>إدفع الآن</button>
                </div>
                ...
                <div className={styles.walletGrid}>
                    <div className={styles.walletCard}>
                        ...
                        <div>
                            ...
                            <p className={styles.spanPay}>تدفع لمرة واحدة فقط</p>
                    ...
                    <div className={styles.walletCard}>
                        <span>⏳</span>
                        <div>
                            <p>قراءة الساعة الأولية</p>
                            <h4>KILO {userData.wallet.initialReading}</h4>
                        </div>
                    </div>
                </div>
